...
are all namable lists and may appear at the outer level of source documents.  All
...
The generic feature type is called _feature_.  It may contain elementary features
such as paths and polygons or it may, without restriction, contain collections of
features: _route_, _segment_, and indeed, other _feature_ lists.
